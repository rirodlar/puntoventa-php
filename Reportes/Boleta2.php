...
//    $this->Cell(18, 10, '', 1);
    ...
    $this->Cell(50, 10, $numero, 0);
     ...
     $this->Ln(4);
      $this->Cell(140, 20, '', 0);
      $this->Cell(100, 8, 'Emision: '.$fecha, 0);
//    $this->Ln(25);
//    $this->SetFont('Arial', 'B', 11);
    $this->Ln(8);
    $this->Cell(130, 8, '', 0);
    $this->Cell(60, 8, $nombre, 0);
    $this->Ln(4);
...
//    $this->Cell(80, 8, 'Nombre', 1);
//    $this->Cell(40, 8, 'Tipo', 1);
//    $this->Cell(25, 8, 'P. Unitario', 1);
//    $this->Cell(25, 8, 'P. Distribuidor', 1);
    $this->Ln(4);
    $this->SetFont('Arial', '', 9);
    $item = 0;
    while ($reg = $query_ped->fetch_object()) {
        $item = $item+1;
        $this->Cell(30, 8, $reg->articulo, 0);
	$this->Cell(10, 8, $reg->cantidad, 0);
	$this->Cell(80, 8, $reg->descripcion, 0);
        $this->Cell(30, 8, '',0);
	$this->Cell(25, 8, $reg->precio_venta, 0);
	//$this->Cell(25, 8, 'S/. '.$reg->descuento
               // , 0);
	$this->Ln(4);
    }
    $this->Ln(5);
      $this->Cell(150, 8, '', 0);
    $this->Cell(25, 8, $reg_total, 0);
    $this->Ln(8);
   for ($contador = 0; $contador < $num_cuotas; $contador++) {
        $this->Cell(30, 8, $contador+1,0);
        $valorFecha = $fecha .' +'.  ($contador+1) . " months";
      
        $this->Cell(30, 8, $valorFecha ,0);
        $this->Ln(4);
    }
