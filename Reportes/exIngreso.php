...
$pdf->addSociete( $reg_cli->razon_social,
                 ...
                 utf8_decode( "Dirección:").utf8_decode( "$reg_cli->direccion")."\n".
...
//$pdf->addClient("CL01");
//$pdf->addPageNumber("1");
$pdf->addClientAdresse(utf8_decode("Razón Social: ").utf8_decode($reg_cli->nombre),"Domicilio: ".utf8_decode($reg_cli->direccion_calle),$reg_cli->tipo_documento.": ".$reg_cli->num_documento,"Email: ".$reg_cli->email,"Telefono: ".$reg_cli->telefono);
