...
$pdf->addDate( '2016-10-23');
$pdf->temporaire( "" );
//$pdf->addDate( $reg_cli->fecha);
$pdf->addClient("CL01");
////$pdf->addPageNumber("1");
//
//$pdf->addClientAdresse(utf8_decode($reg_cli->nombre),"Domicilio: ".utf8_decode($reg_cli->direccion_calle),utf8_decode($reg_cli->doc).": ".$reg_cli->num_documento,"Email: ".$reg_cli->email,"Telefono: ".$reg_cli->telefono);
